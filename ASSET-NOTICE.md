# 图像资源说明 / Image asset notice

`spritesheet.webp` 与 `assets/*.gif` 是依据小八模型和实物照片制作的非官方同人动画，经过 AI 辅助生成、帧整理和透明边缘处理。原始模型与参考照片没有包含在本仓库中。

这些图像不适用代码的 MIT 许可。就维护者有权许可的新增制作部分，允许下载、复制及修改，用于个人桌面宠物和非商业同人分享；分享时请保留本说明和仓库出处。此许可不授予原角色、参考模型、照片或第三方商标的权利，也不表示相关权利人的认可。
